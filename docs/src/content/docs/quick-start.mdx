...
how to create stores, manage collections, work with documents, and use advanced features like querying and verification.
...
- **[WAL](/docs/wal)**: Write-Ahead Logging for durability and crash recovery
