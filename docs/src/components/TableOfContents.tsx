...
export default function TableOfContents({ headings: propHeadings }: TableOfContentsProps) {
    ...
    return (
        <nav
            className="hidden xl:block py-8 lg:py-12 w-64 sticky top-20 mr-4 h-fit"
            aria-label="Table of contents"
        >
            <div className="bg-background pb-2 z-10">
                <h4 className="text-sm font-semibold text-foreground mb-2">On This Page</h4>
            </div>
            <ul className="text-sm border-l-2 mb-4 max-h-[calc(100vh-11rem)] overflow-y-auto overscroll-contain">
